...
```dataview
TABLE WITHOUT ID link(file.name) AS "Character Name", Player, ac, pasperc As "Pass Perc (WIS)", insperc as "Insight Perc (WIS)"
from "1-Party"
...
actions:
  - type: templaterCreateNote
    templateFile: "z_Templates/TemplateRegion.md"
    fileName: NewRegion
```
