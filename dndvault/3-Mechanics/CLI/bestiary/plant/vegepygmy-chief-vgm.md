...
BestiaryType: plant
SourceType: Bestiary
BookSource: Volo's Guide to Monsters p. 197
---
...
The fungus known as russet mold is reddish-brown in color and found only in places that are dark, warm, and wet. Russet mold that spreads out across a metal object can be mistaken for natural rust, and a successful DC 15 Intelligence ([Nature](/3-Mechanics/CLI/rules/skills.md#Nature)) or Wisdom ([Survival](/3-Mechanics/CLI/rules/skills.md#Survival)) check is required to identify it accurately by sight in such a case.
...
- "desc": "The vegepygmy regains 5 hit points at the start of its turn. If it takes\
  ...
  "name": "Regeneration"
"actions":
- "desc": "The vegepygmy makes two attacks with its claws or two melee attacks with\
    \ its spear."
  "name": "Multiattack"
...
- "VGM"
- "ToA"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/VGM/Vegepygmy%20Chief.webp"
```
^statblock
