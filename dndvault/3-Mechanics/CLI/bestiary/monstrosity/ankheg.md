...
SourceType: Bestiary
BookSource: Monster Manual p. 21, Dragon of Icespire Peak. Available in the SRD.
---
# [Ankheg](3-Mechanics\CLI\bestiary\monstrosity/ankheg.md)
*Source: Monster Manual p. 21, Dragon of Icespire Peak. Available in the SRD.*  
...
- "desc": "Melee Weapon Attack: dice: d20+5 (+5) to hit, reach 5 ft., one target.\
    ...
    \ (1d6) acid damage. If the target is a Large or smaller creature, it is [grappled](/3-Mechanics/CLI/rules/conditions.md#grappled)\
