...
- "desc": "Melee Weapon Attack: dice: d20+10 (+10) to hit, reach 5 ft., one\
    ...
    \ On a failure, the target is [poisoned](/3-Mechanics/CLI/rules/conditions.md#poisoned)\
...
- "desc": "Ranged Weapon Attack: dice: d20+7 (+7) to hit, range 100/400 ft.,\
    ...
    \ a successful DC 17 Dexterity saving throw or be [restrained](/3-Mechanics/CLI/rules/conditions.md#restrained)\
    ...
    \ a successful DC 17 Constitution saving throw or be [paralyzed](/3-Mechanics/CLI/rules/conditions.md#paralyzed)\
