...
```statblock
"name": "Xvart Warlock of Raxivort (VGM)"
"size": "Small"
"type": "humanoid"
"subtype": "xvart"
...
"cr": "1"
"traits":
- "desc": "The xvart's innate spellcasting ability is Charisma. it can innately cast\
    \ the following spells, requiring no material components:\n\nAt will: [detect\
    \ magic](/3-Mechanics/CLI/spells/detect-magic.md), [mage armor](/3-Mechanics/CLI/spells/mage-armor.md)\
    \ (self only)"
  "name": "Innate Spellcasting"
- "desc": "The xvart is a 3rd-level spellcaster. Its spellcasting ability is Charisma\
    \ (spell save DC 11, dice: d20+3 (+3) to hit with spell attacks). It regains\
    ...
    \ [expeditious retreat](/3-Mechanics/CLI/spells/expeditious-retreat.md), [invisibility](/3-Mechanics/CLI/spells/invisibility.md),\
...
- "desc": "The xvart can take the Disengage action as a bonus action on each of its\
    \ turns."
  "name": "Low Cunning"
- "desc": "The xvart has advantage on Strength ([Athletics](/3-Mechanics/CLI/rules/skills.md#Athletics))\
    \ checks to shove a creature if at least one of the xvart's allies is within 5\
    \ feet of the target and the ally isn't [incapacitated](/3-Mechanics/CLI/rules/conditions.md#incapacitated)."
...
"source":
- "VGM"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/VGM/Xvart%20Warlock%20of%20Raxivort.webp"
```
^statblock
