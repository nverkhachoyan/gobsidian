...
The lich magically emits psychic energy in a 60-foot cone. Each creature in that area must succeed on a DC 18 Intelligence saving throw or take `dice:5d8 + 5|text(27)` (`5d8 + 5`) psychic damage and be [stunned](/3-Mechanics/CLI/rules/conditions.md#stunned) for 1 minute. A creature can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.
...
- "desc": "Melee Weapon Attack: dice: d20+12 (+12) to hit, reach 5 ft., one\
    ...
    \ target is Large or smaller, it is [grappled](/3-Mechanics/CLI/rules/conditions.md#grappled)\
  ...
  "name": "Tentacles"
- "desc": "Melee Weapon Attack: dice: d20+12 (+12) to hit, reach 5 ft., one\
    \ [incapacitated](/3-Mechanics/CLI/rules/conditions.md#incapacitated) humanoid\
    \ [grappled](/3-Mechanics/CLI/rules/conditions.md#grappled) by the lich. Hit:\
    \ dice:10d10|text(55) (10d10) piercing damage. If this damage reduces the\
...
- "desc": "The illithilich magically emits psychic energy in a 60-foot cone. Each\
    ...
    \ dice:5d8 + 5|text(27) (5d8 + 5) psychic damage and be [stunned](/3-Mechanics/CLI/rules/conditions.md#stunned)\
