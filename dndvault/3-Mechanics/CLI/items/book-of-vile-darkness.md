...
If a [solar](/3-Mechanics/CLI/bestiary/celestial/solar.md) tears the book in two, the book is destroyed for `dice: 1d100|avg|noform` (`1d100`) years, after which it reforms in some dark corner of the multiverse.
