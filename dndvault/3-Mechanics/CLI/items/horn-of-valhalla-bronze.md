...
A bronze horn summons `dice: 4d4 + 4|avg|noform` (`4d4 + 4`) [berserkers](/3-Mechanics/CLI/bestiary/humanoid/berserker.md). To use the bronze horn, you must be proficient with medium armor.
