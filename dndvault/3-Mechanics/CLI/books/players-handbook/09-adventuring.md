...
At the end of a fall, a creature takes `dice: 1d6|avg|noform` (`1d6`) bludgeoning damage for every 10 feet it fell, to a maximum of `dice: 20d6|avg|noform` (`20d6`). The creature lands [prone](/3-Mechanics/CLI/rules/conditions.md#prone), unless it avoids taking damage from the fall.
